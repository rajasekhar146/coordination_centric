        ...
        <div className="db__main__div">
            <div className="db__row">
                ...
                <div className="db__card__content">
                    <div><img src={AppointmentsIcon} alt="Appointments" /></div>
                    </div>
                    <div>
                ...
                <div className="db__row">
                <div className="db__card__content">
                    <div><img src={NewPatientsIcon} alt="New Patients" /></div>
                    </div>
                    <div>
                ...
                <div className="db__row">
                <div className="db__card__content">
                    <div><img src={OperationsIcon} alt="Operations" /></div>
                    </div>
                    <div>
                ...
                <div className="db__row">
                    <div className="db__card__content">
                        <div><img src={HospitalEarningsIcon} alt="Hospital Earnings" />
                        </div></div>
                    <div>
