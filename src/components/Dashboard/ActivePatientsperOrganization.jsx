...
const ActivePatientsperOrganization = (props) => {
    ...
    const getValue = () => {
        switch (role) {
            case 'doctor':
            case 'patient':
                return get(dashboardDetails, ['activePatients'], 0)
                break
            case 'superadmin':
                return get(dashboardDetails, ['0', 'totals', 'activePatients'], 0)
                break
            case 'admin':
                return get(dashboardDetails, ['0', 'totals', 'activePatients'], 0)
        }
...
export default withStyles(styles)(ActivePatientsperOrganization)