            ...
            <form>
              <div className="io__form form-body">
                ...
                <div className="io__row">
                    ...
                    <TextField  {...useInput('facilityName', { isRequired: true })} className="od__text__box" margin="normal" InputProps={{
                        startAdornment: (
                ...
                <div className="io__row">
                    ...
                    <TextField {...useInput('facilityEmail', { isRequired: true })} className="od__text__box" margin="normal" InputProps={{
                        startAdornment: (
                          <InputAdornment position="start">
                ...
                <div className="io__row">
                    ...
                    <TextField {...useInput('facilityAddress', { isRequired: true })} className="od__text__box" margin="normal" InputProps={{
                        startAdornment: (
                          <InputAdornment position="start">
                ...
                <div className="io__row">
                    ...
                    <TextField {...useInput('facilityPhone', { isRequired: true })} className="od__text__box" margin="normal" InputProps={{
                        startAdornment: (
                          <InputAdornment position="start">
                ...
                <div className="io__row">
                    <div className="io__same__line">
                        ...
                        <div className="io__column io__invite__org__btn">
                            <Button className="io__add__organization__btn" disabled={!isValid} onClick={handleSubmit}>
                                Invite Organization
                            </Button>
                        </div>
                    </div>
