        ...
        <div className="si__main__div">
            ...
            <div className="si__right__div"> 
                <div className="si__right__content">
                    ...
                    <div className="si__right__label">Email &nbsp;<span className="ac__required">*</span></div>
                    <div><TextField id="" defaultValue="Email" className="si__text__box" margin="normal" /></div>
                    <div className="si__right__label">Password &nbsp;<span className="ac__required">*</span></div>
                    <div><TextField id="" defaultValue="Password" className="si__text__box" margin="normal" /></div>
                    <div> <FormControlLabel control={<Checkbox defaultChecked />} className="si__check__box__text"  label="Keep me signin?" /> </div>
                    <div> <Button className="si__login__btn" onClick={handleLogin}>  Login </Button> </div>
