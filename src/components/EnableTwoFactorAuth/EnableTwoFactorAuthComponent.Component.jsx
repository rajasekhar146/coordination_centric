  ...
  return (
    <div className="io__two_fa">
      <div className="io__two_justify">
        <div>
          <label className="header__label">Enable Two Factor Authentication</label>
        </div>
        <div className="io__two_justify">
          <label className="info__label">
            Add an extra layer of security to your Coordination Centric account by enabling two-factor authentication -
            an entirely optional feature of your account. If enabled you will be required to enter a variable code
            generated by authenticator app each time you log in.
          </label>
        </div>
