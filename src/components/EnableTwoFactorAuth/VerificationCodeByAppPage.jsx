            ...
            <div>
                <div className="io__tf__app">
                    ...
                    <div className="io__step__padding0">
                        <div>
                            <label className="io__download__label">
                                Download an authenticator app
                            </label>
                        </div>
                        <div>
                            <label className="io__download__sublabel">
                                Download on your smartphone, tablet, laptop or desktop.
                                We recommend Google Authenticator for iOS and Android,
                                and Authy for desktop and laptops.
                            </label>
                        </div>
                        <div>
                    ...
                    <div className="io__step__padding0">
                        ...
                        <div>
                            <label className="io__download__sublabel io__qr_label">
                                Use your authenticator app to scan the QR code if using
                                a smartphone or tablet, or enter the secret key if using
                                a desktop or laptop, to get a verification code.
                                We strongly recommend saving your secret key in a
                                secure password manager. It will not be visible to
                                you once the process is complete.
                            </label>
                        </div>
                        <div>
                            <label className="io__secret__key">
                                Secret Key
                            </label>
                    ...
                    <div className="io__step__padding0">
                        ...
                        <div>
                            <label className="io__download__sublabel io__width70">
                                Enter the verification code presented in your
                                authentication app to complete the enabling process.
                            </label>
                        </div>
