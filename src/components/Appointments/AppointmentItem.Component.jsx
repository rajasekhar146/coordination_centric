...
const menuList = [
  {
    ...
    doctorOptions: [
      ...
      {
        text: 'Re-schedule',
        fnKey: 'setIsRescheduleClicked',
        icon: require('../../assets/icons/resend_calender.png').default,
      },
      {
        text: 'Cancel Appointment',
        fnKey: 'setCancelAppointmentReason',
        icon: require('../../assets/icons/reject.png').default,
      },
    ],
    patientOptions: [
      { text: 'View', fnKey: 'setIsViewClicked', icon: require('../../assets/icons/view_details.png').default },
      {
        text: 'Re-schedule',
        fnKey: 'setPatientReschedule',
        icon: require('../../assets/icons/resend_calender.png').default,
      },
      {
        text: 'Cancel Appointment',
        fnKey: 'setCancelAppointment',
        icon: require('../../assets/icons/reject.png').default,
      },
    ],
    historyOptions: [
        ...
        return column.id == 'status' ? (
          ...
          >
            <div className={`od__${value?.toLowerCase()}__status`}>
              ...
              <div className={`od__${value?.toLowerCase()}__label`}>{getValue(value)}</div>
            </div>
          </TableCell>
        ) : column.id == 'profile' ? (
          <TableCell
